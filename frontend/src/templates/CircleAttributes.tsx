...
function CircleAttributes() {
  return (
    <div>
      <div className="hidden md:block grid grid-cols-1 divide-y divide-black px-6 space-y-20 ">
        <div className="flex relative grid grid-cols-5 py-8 justify-center items-stretch items-center ">
